...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/nb_utils.ipynb.

# %% auto 0
__all__ = ['pydantic_to_markdown_table']

# %% ../nbs/nb_utils.ipynb 3
import inspect
from typing import Type, Any, Optional, get_type_hints, get_origin, get_args
from pydantic import BaseModel, Field
from IPython.display import display, Markdown


# %% ../nbs/nb_utils.ipynb 5
